...
const canvasBezierCubicCurve = document.getElementById("canvasBezierCubicCurve");
...
function drawBezierCubicCurve() {
  if (canvasBezierCubicCurve.getContext) {
    const ctx = canvasBezierCubicCurve.getContext("2d");
